...
class DynamicDesiredRetentionPlotDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        fixed_target_weights: Sequence[float] = (),
        fixed_target_drs: Sequence[float] = (),
        retention_min: float,
        retention_max: float,
        ...
        payload: dict[str, Any] = {
            ...
            "fixedTargetWeights": list(fixed_target_weights),
            "fixedTargetDrs": list(fixed_target_drs),
...
def open_dynamic_desired_retention_plot(
    ...
    *,
    ...
    dialog = DynamicDesiredRetentionPlotDialog(
        ...
        fixed_target_drs=fixed_target_drs,
